...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  :root {
    /* Default Tenant Colors (Metalúrgica Alto Valle S.A.) */
    --primary: 60, 132, 118;
    --secondary: 89, 190, 151;
    --success: 16, 185, 129;
    --warning: 245, 158, 11;
    --error: 244, 63, 94;
    --info: 59, 130, 246;
...
.saas-input:focus {
  ...
  --tw-ring-color: rgba(var(--primary), 0.1);
}
.btn-primary {
  display: inline-flex;
  align-items: center;
  ...
  --tw-gradient-from: rgba(var(--primary), 1) var(--tw-gradient-from-position);
  --tw-gradient-to: rgba(var(--primary), 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
  --tw-gradient-to: rgba(var(--secondary), 1) var(--tw-gradient-to-position);
  padding-left: 1.5rem;
  ...
  --tw-shadow: 0 4px 6px -1px rgba(var(--primary),0.2);
...
.btn-primary:hover {
  ...
  --tw-shadow: 0 10px 15px -3px rgba(var(--primary),0.3);
...
.border-semantic-error {
  --tw-border-opacity: 1;
  border-color: rgba(var(--error), var(--tw-border-opacity, 1));
}
.border-semantic-error\/20 {
  border-color: rgba(var(--error), 0.2);
}
.border-semantic-info\/20 {
...
.border-semantic-warning {
  --tw-border-opacity: 1;
  border-color: rgba(var(--warning), var(--tw-border-opacity, 1));
}
...
.bg-semantic-error {
  --tw-bg-opacity: 1;
  background-color: rgba(var(--error), var(--tw-bg-opacity, 1));
}
...
.bg-semantic-success {
  --tw-bg-opacity: 1;
  background-color: rgba(var(--success), var(--tw-bg-opacity, 1));
}
...
.bg-semantic-warning {
  --tw-bg-opacity: 1;
  background-color: rgba(var(--warning), var(--tw-bg-opacity, 1));
}
...
.from-brand-secondary\/20 {
  --tw-gradient-from: rgba(var(--secondary), 0.2) var(--tw-gradient-from-position);
  --tw-gradient-to: rgba(var(--secondary), 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.via-slate-50 {
...
.text-semantic-error {
  --tw-text-opacity: 1;
  color: rgba(var(--error), var(--tw-text-opacity, 1));
}
.text-semantic-info {
  --tw-text-opacity: 1;
  color: rgba(var(--info), var(--tw-text-opacity, 1));
}
.text-semantic-success {
  --tw-text-opacity: 1;
  color: rgba(var(--success), var(--tw-text-opacity, 1));
}
.text-semantic-warning {
  --tw-text-opacity: 1;
  color: rgba(var(--warning), var(--tw-text-opacity, 1));
}
.text-slate-300 {
  --tw-text-opacity: 1;
...
.shadow-\[0_4px_20px_-2px_rgba\(0\2c 0\2c 0\2c 0\.05\)\] {
...
.shadow-semantic-error\/30 {
  --tw-shadow-color: rgba(var(--error), 0.3);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-semantic-success\/30 {
  --tw-shadow-color: rgba(var(--success), 0.3);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-brand-primary\/30 {
  --tw-shadow-color: rgba(var(--primary), 0.3);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-semantic-error\/10 {
  --tw-shadow-color: rgba(var(--error), 0.1);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-semantic-success\/10 {
  --tw-shadow-color: rgba(var(--success), 0.1);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-brand-primary\/20 {
  --tw-shadow-color: rgba(var(--primary), 0.2);
  --tw-shadow: var(--tw-shadow-colored);
}
.outline-none {
  outline: 2px solid transparent;
...
.focus\:ring-brand-primary:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgba(var(--primary), var(--tw-ring-opacity, 1));
}
...
.group:focus-within .group-focus-within\:text-brand-primary {
  --tw-text-opacity: 1;
  color: rgba(var(--primary), var(--tw-text-opacity, 1));
}
